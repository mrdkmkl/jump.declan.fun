...
const SHOP_ITEMS = [
  // ── MOVEMENT ──
  {id:'double_jump',    icon:'🦅',    name:'double jump',    desc:'one extra mid-air jump this round',            price:120,  type:'run', key:'doubleJump'},
  {id:'triple_jump',    icon:'🦅🦅',  name:'triple jump',    desc:'two extra mid-air jumps this round',           price:145, type:'run', key:'tripleJump'},
  {id:'quad_jump',      icon:'🦅🦅🦅',name:'quad jump',      desc:'three extra mid-air jumps this round',         price:170, type:'run', key:'quadJump'},
  {id:'spring_boots',   icon:'🥾',    name:'spring boots',   desc:'jump 25% higher this round',                  price:126,  type:'run', key:'springBoots'},
  {id:'hyper_boots',    icon:'👟',    name:'hyper boots',    desc:'jump 50% higher — bounces too',                price:145, type:'run', key:'hyperBoots'},
  {id:'slow_fall',      icon:'🪂',    name:'slow fall',      desc:'hold ↑ to glide slowly this round',           price:125,  type:'run', key:'slowFall'},
  {id:'jetpack',        icon:'🚀',    name:'jetpack',        desc:'unlimited jumps for 10 seconds',               price:356, type:'run', key:'jetpack'},
  {id:'rocket_boost',   icon:'🔥',    name:'rocket boost',   desc:'+3 ultra boost charges for this round',       price:795, type:'run', key:'rocketBoost'},
  {id:'turbo',          icon:'🏎️',    name:'turbo',          desc:'move 30% faster left/right',                  price:897, type:'run', key:'turbo'},
  {id:'wall_bounce',    icon:'🏀',    name:'wall bounce',    desc:'bounce off screen edges instead of wrapping', price:565,  type:'run', key:'wallBounce'},
  {id:'low_gravity',    icon:'🌙',    name:'low gravity',    desc:'reduced gravity — floatier jumps all round',   price:600, type:'run', key:'lowGravity'},
  // ── COLLECTION ──
  {id:'coin_double',    icon:'💰',    name:'coin×2',         desc:'earn double coins this entire round',          price:1200,  type:'run', key:'coinDouble'},
  {id:'coin_triple',    icon:'💎',    name:'coin×3',         desc:'earn triple coins this entire round',          price:2000, type:'run', key:'coinTriple'},
  {id:'coin_quintuple', icon:'💎💎',  name:'coin×5',         desc:'earn 5× coins this entire round',             price:3200, type:'run', key:'coinQuintuple'},
  {id:'magnet',         icon:'🧲',    name:'coin magnet',    desc:'auto-collect nearby coins this round',         price:580,  type:'run', key:'magnet'},
  {id:'magnet_plus',    icon:'🧲✨',  name:'super magnet',   desc:'mega coin attraction radius this round',       price:740, type:'run', key:'magnetPlus'},
  {id:'coin_trail',     icon:'🌟',    name:'star trail',     desc:'leave a trail that collects coins around you', price:640, type:'run', key:'coinTrail'},
  // ── SURVIVAL ──
  {id:'shield',         icon:'🛡️',    name:'shield',         desc:'survive one deadly fall this round',           price:1000, type:'run', key:'shield'},
  {id:'double_shield',  icon:'🛡️🛡️',  name:'double shield',  desc:'survive two deadly falls this round',         price:2000, type:'run', key:'doubleShield'},
  {id:'triple_shield',  icon:'🛡️🛡️🛡️',name:'triple shield',  desc:'survive three deadly falls this round',      price:3000, type:'run', key:'tripleShield'},
  {id:'ghost',          icon:'👻',    name:'ghost mode',     desc:'phase through dissolving platforms this round',price:630, type:'run', key:'ghost'},
  {id:'last_chance',    icon:'🫀',    name:'last chance',    desc:'auto-triggers ultra boost when you fall off',  price:750, type:'run', key:'lastChance'},
  {id:'sticky_boots',   icon:'🦶',    name:'sticky boots',   desc:'stay on dissolving platforms 2× longer',      price:570,  type:'run', key:'stickyBoots'},
  // ── BOOSTS ──
  {id:'boost_tank',     icon:'⚡',    name:'boost tank',     desc:'+4 boost charges for this round',             price:560,  type:'run', key:'boostTank'},
  {id:'boost_tank2',    icon:'⚡⚡',  name:'mega tank',      desc:'+8 boost charges for this round',             price:660, type:'run', key:'boostTank2'},
  {id:'boost_regen',    icon:'🔋',    name:'boost regen',    desc:'boosts regenerate automatically over time',   price:700, type:'run', key:'boostRegen'},
  {id:'free_boost',     icon:'🆓',    name:'free boost',     desc:'first 3 boosts each platform are free',       price:620, type:'run', key:'freeBoost'},
  // ── SPECIAL ──
  ...
  // ── NEW ITEMS ──
  {id:'phase_dash',     icon:'💨',    name:'phase dash',     desc:'double-tap left/right to dash through platforms',price:689, type:'run', key:'phaseDash'},
  {id:'score_saver',    icon:'🏦',    name:'score saver',    desc:'your high score cannot be beaten this run — only tied or improved',price:681, type:'run', key:'scoreSaver'},
  {id:'coin_interest',  icon:'📊',    name:'coin interest',  desc:'earn +1 coin every 5 seconds automatically',    price:642, type:'run', key:'coinInterest'},
  {id:'double_boost',   icon:'⚡⚡', name:'double boost',   desc:'each boost charge counts as two this round',     price:721, type:'run', key:'doubleBoost'},
  ...
  {id:'safe_landing',   icon:'🛬',    name:'safe landing',   desc:'never die from hitting the ground for 3 falls', price:3000, type:'run', key:'safeLanding'},
  {id:'score_streak',   icon:'🔥',    name:'score streak',   desc:'land 5 platforms in a row for a 2× score burst', price:661, type:'run', key:'scoreStreak'},
  {id:'rainbow_trail',  icon:'🌈',    name:'rainbow trail',  desc:'leave a rainbow trail — also attracts coins',   price:611, type:'run', key:'rainbowTrail'},
  {id:'death_save',     icon:'💀',    name:'death save',     desc:'if you die, respawn once on the nearest platform',price:951,type:'run', key:'deathSave'},
  // ── VALUE BUNDLES (20c, stacked benefits) ──
  {id:'starter_pack',   icon:'🎁',    name:'starter pack',   desc:'double jump + boost tank + coin×2, all in one', price:7000, type:'run', key:'starterPack'},
  {id:'safety_net',     icon:'🪢',    name:'safety net',     desc:'shield + sticky boots + platform radar, bundled', price:7200, type:'run', key:'safetyNet'},
  {id:'speed_demon',    icon:'🌪️',    name:'speed demon',    desc:'turbo + hyper boots + low gravity, bundled',   price:7000, type:'run', key:'speedDemon'},
  {id:'coin_rush',      icon:'🤑',    name:'coin rush',      desc:'coin×3 + magnet + coin shower, bundled',       price:7000, type:'run', key:'coinRush'},
  {id:'survivor_kit',   icon:'🧰',    name:'survivor kit',   desc:'mega boost tank + no dissolve + wide platforms',price:7000, type:'run', key:'survivorKit'},
];
...
const SKINS = [
  ...
  {id:'skin_tiger',    name:'tiger',     price:550,      body:'#ff9f40', colors:['#ff9f40','#1a1a1a'], accent:'rgba(60,30,0,.9)', special:'stripes', coinMult:1},
  {id:'skin_moss',     name:'moss',      price:3250,      body:'#7a8f5c', accent:'rgba(35,50,20,.85)', special:null, coinMult:1},
  {id:'skin_pebble',   name:'pebble',    price:4250,      body:'#c9c9c9', accent:'rgba(70,70,70,.85)', special:null, coinMult:1.5},
  {id:'skin_coral',    name:'coral',     price:5500,     body:'#ff6b6b', accent:'rgba(140,20,20,.85)', special:null, coinMult:2},
  {id:'skin_lilac',    name:'lilac',     price:7000,     body:'#c9a8e0', accent:'rgba(90,55,110,.85)', special:null, coinMult:2.5},
  {id:'skin_seafoam',  name:'seafoam',   price:9000,     body:'#8fd9c4', accent:'rgba(20,80,60,.85)', special:null, coinMult:3.5},
  {id:'skin_peach',    name:'peach',     price:11500,     body:'#ffbfa0', accent:'rgba(140,70,30,.85)', special:null, coinMult:4.5},
  {id:'skin_sunbeam',  name:'sunbeam',   price:15000,    body:'#ffd93d', accent:'rgba(150,110,0,.85)', special:null, coinMult:5},
  {id:'skin_mint',     name:'mint',      price:19500,    body:'#6bcf9c', accent:'rgba(15,90,55,.85)', special:null, coinMult:7},
  {id:'skin_candy',    name:'candy stripe', price:25000, body:'#ff6b9d', colors:['#ff6b9d','#6bd6ff'], accent:'rgba(120,20,70,.85)', special:'stripes', coinMult:8},
  {id:'skin_sky',      name:'sky',       price:32500,    body:'#5aa9e6', accent:'rgba(10,60,110,.85)', special:null, coinMult:10},
  {id:'skin_sunset',   name:'sunset',    price:42000,    body:'#ff9a56', colors:['#ff9a56','#ff6b9d','#845ec2'], accent:'rgba(90,30,70,.9)', special:'gradient', coinMult:12},
  {id:'skin_grape',    name:'grape',     price:54000,   body:'#a66bd6', accent:'rgba(70,20,100,.85)', special:null, coinMult:14},
  {id:'skin_aurora',   name:'aurora',    price:70000,   body:'#00c9a7', colors:['#00c9a7','#4d8dff','#845ec2'], accent:'rgba(15,50,80,.9)', special:'gradient', coinMult:18},
  {id:'skin_galaxy',   name:'galaxy',    price:90000,   body:'#1b1240', colors:['#ff6bd6','#6bd6ff','#ffe66b','#a66bd6'], accent:'rgba(200,200,255,.85)', special:'galaxy', coinMult:22},
  {id:'skin_copper',   name:'copper',    price:116000,   body:'#c07a4a', accent:'rgba(90,45,15,.9)', special:'metal', coinMult:25},
  {id:'skin_ember',    name:'ember',     price:150000,   body:'#ff7b3f', accent:'rgba(120,35,0,.85)', special:'glow', coinMult:27},
  {id:'skin_silver',   name:'silver',    price:194000,   body:'#c7ccd1', accent:'rgba(70,75,80,.9)', special:'metal', coinMult:29},
  {id:'skin_camo',     name:'tropical camo', price:250000, body:'#6bcf9c', colors:['#6bcf9c','#ffd93d','#ff6b6b','#4d8dff'], accent:'rgba(20,60,30,.9)', special:'camo', coinMult:32},
  {id:'skin_titanium', name:'titanium',  price:323000,   body:'#8a92a6', accent:'rgba(40,45,60,.9)', special:'metal', coinMult:34},
  {id:'skin_obsidian', name:'obsidian',  price:417000,  body:'#2b2b3a', accent:'rgba(180,180,220,.85)', special:'glow', coinMult:36},
  {id:'skin_platinum', name:'platinum',  price:539000,  body:'#e2e6ea', accent:'rgba(90,95,100,.9)', special:'metal', coinMult:40},
  {id:'skin_gold',     name:'gold',      price:696000,  body:'#ffcc33', accent:'rgba(110,70,0,.9)', special:'shine', coinMult:43},
  {id:'skin_sunny',    name:'sunny',     price:899000,  body:'#ffe14d', accent:'rgba(150,110,0,.9)', special:'sunny', coinMult:45},
  {id:'skin_holo',     name:'holo',      price:1160000,  body:'holo',    accent:'rgba(60,20,90,.85)', special:'holo', coinMult:48},
  {id:'skin_diamond',  name:'diamond',   price:1500000, body:'#bdf3ff', accent:'rgba(20,80,100,.9)', special:'shine', coinMult:95},
];
const SKINS_UNLOCK_COST = 1000;

/* ── PETS — permanent, only one equipped at a time; boost speed + coins ── */
const PETS = [
  {id:'pet_panda',   icon:'🐼', name:'panda',   price:10000,  speedMult:1.05, coinMult:1.10, desc:'small speed boost · +10% coins'},
  {id:'pet_giraffe', icon:'🦒', name:'giraffe', price:50000,  speedMult:1.10, coinMult:1.25, desc:'better speed · +25% coins'},
  {id:'pet_turtle',  icon:'🐢', name:'turtle',  price:100000, speedMult:1.15, coinMult:1.50, desc:'strong speed · +50% coins'},
  {id:'pet_seal',    icon:'🦭', name:'seal',    price:2000000, speedMult:1.25, coinMult:2.00, desc:'max speed · double coins'},
];
